...
FROM 'C:\Users\user1\Documents\CodeCollegeZA\BootCamp_2023\SQL\classwork\chapter11\yellow_tripdata_2016_06_01.csv'
...
TO 'C:\Users\user1\Documents\CodeCollegeZA\BootCamp_2023\SQL\classwork\chapter11\hourly_pickups_2016_06_01.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
...
--------------------------------------------------------------
-- QUESTION 1.
-- The longest trips are almost 24 hours and the shortest trips are less 
-- than zero minutes, there could be a timestap error when capturing the data.
SELECT
    trip_id,
    tpep_pickup_datetime,
    tpep_dropoff_datetime,
...
-- Cost of a taxi ride is based on both time and distance.
